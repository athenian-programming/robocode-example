...
public class BorderGuard
   ...
   *
   * @param scannedRobotEvent is a ScannedRobotEvent event.
   */
  @Override
   ...
   *
   * @param robotDeathEvent is the RobotDeathEvent that occurs, when another robot dies, which contains data
   ...
   *
   * @param g is the {@link Graphics2D} object, which is the graphics context used for painting
   ...
   *
   * @param scannedRobotEvent is a ScannedRobotEvent event containing data about a scanned robot.
   */
   ...
   *
   * @param value is the input value to limit.
   * @param min   is the allowed minimum value.
   * @param max   is the allowed maximum value.
